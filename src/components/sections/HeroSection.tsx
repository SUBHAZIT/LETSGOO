...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-end overflow-hidden">
      ...
      <button
        onClick={toggleMute}
        className="absolute bottom-8 right-8 z-20 w-12 h-12 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center hover:bg-card transition-colors"
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {quickLinks.map((link, index) => (
                ...
                >
                  <Link
                    to={link.href}
                    className="bg-card/95 backdrop-blur-sm rounded-2xl p-4 flex items-center gap-3 hover:bg-card transition-colors group h-full"
                  >
              ...
              >
                <Link 
                  to="/hotels"
                  className="relative rounded-2xl overflow-hidden h-28 group block"
                >
                  <img 
                    src={itineraryKerala} 
                    alt="Hotels"
